...
def get_config():
    ...
    parser.add_argument(
        "--seed", type=int, default=114514, help="Random seed for numpy/torch"
    )
    parser.add_argument(
        "--seed_specify",
        action="store_true",
    ...
    # env parameters
    parser.add_argument(
        "--env_name", type=str, default="Vanet", help="specify the name of environment"
    )
    parser.add_argument(
        "--use_obs_instead_of_state",
        action="store_true",
    ...
    # replay buffer parameters
    parser.add_argument(
        "--episode_length", type=int, default=36000, help="Max length for any episode"
    )
    ...
    parser.add_argument(
        "--use_CADP", action="store_true", default=False, help="Whether to use CADP"
    )
    parser.add_argument(
        "--cadp_breakpoint", type=int, default=3000000, help="cadp breakpoint"
    )
    ...
    # ppo parameters
    parser.add_argument(
        "--ppo_epoch", type=int, default=5, help="number of ppo epochs (default: 5)"
    )
    parser.add_argument(
        "--use_clipped_value_loss",
        action="store_false",
