...
def get_config():
    ...
    parser.add_argument("--seed", type=int, default=114514, help="Random seed for numpy/torch")
    ...
    parser.add_argument("--num_env_steps", type=int, default=36e3,
                        help='Number of environment steps to train (default: 36e3)')
    parser.add_argument("--user_name", type=str, default='1399858762', help="[for wandb usage], to specify user's name for simply collecting training data.")
    parser.add_argument("--use_wandb", action='store_false', default=True, help="[for wandb usage], by default True, will log date to wandb server. or else will use tensorboard to log data.")

    # env parameters
    parser.add_argument("--env_name", type=str, default='Vanet', help="specify the name of environment")
